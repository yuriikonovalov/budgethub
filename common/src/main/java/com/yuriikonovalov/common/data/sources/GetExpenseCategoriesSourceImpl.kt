...
class GetExpenseCategoriesSourceImpl @Inject constructor(
    private val categoriesSourceLocal: CategoriesLocalDataSource
) : GetExpenseCategoriesSource {
    override fun getCategories(): Flow<List<Category>> {
        return categoriesSourceLocal.getCategoriesByType(CategoryType.EXPENSE)
    }
}