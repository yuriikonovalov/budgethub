...
val category = Category(Id.get(), CategoryType.EXPENSE, "Category", false, null, null)
val currency: Currency = Currency("USD", "Dollar", "$")
val account = Account(
    Id.get(),
    "Name",
    AccountType.CARD,
...
fun accounts(number: Int, type: AccountType = AccountType.CARD, cur: Currency = currency) = List(number) { index ->
